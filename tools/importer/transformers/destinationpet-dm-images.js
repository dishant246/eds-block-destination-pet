...
/**
 * Transformer: destinationpet Dynamic Media / Scene7 images.
 * Source uses Scene7 IS/Image URLs on the vanity CNAME images.destpet.com
 * (e.g. https://images.destpet.com/is/image/destpet/...). Rewrites DM <img>
 * tags into carrier anchors so the DM URL round-trips through markdown; the
...
function detectDynamicMediaUrl(urlStr) {
  ...
  // images.destpet.com). Keep byte-identical with dm-scene7-helpers.js.
